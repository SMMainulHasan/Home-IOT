...
#define RELAY_PIN 18 // Solenoid Valve
#define FLOW_SENSOR_PIN 34
#define DHT_SENSOR_PIN 4  // DHT11 Sensor Pin
#define SOIL_SENSOR_PIN 35  // Soil Moisture Sensor Pin
#define SOIL_POWER_PIN 19   // Soil Moisture Sensor Power Pin
